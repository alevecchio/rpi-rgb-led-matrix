...
struct HardwareMapping matrix_hardware_mappings[] = {
   ...
   */
  {
    ...
    /* The intention is to change the GPIO mappings to use only chains 1 and 2
     ...
     */
  {
    ...
    /* Parallel chain 0, RGB for both sub-panels */
    /* Chain 0 pins commented to keep SPI pins free. */  
    ...
    /* All the following are only available with 40 GPIP pins, on A+/B+/Pi2,3 */
    /* Chain 0 used with Chain 1 pins on the board */
    .p0_r1         = GPIO_BIT(12),
    .p0_g1         = GPIO_BIT(5),
    .p0_b1         = GPIO_BIT(6),
    .p0_r2         = GPIO_BIT(19),
    ...
    /* Chain 1 using Chain 2 pins on the board*/
